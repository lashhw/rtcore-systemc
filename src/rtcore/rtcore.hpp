...
SC_MODULE(rtcore) {
    ...
    sync_fifo<bbox_req_t, fifo_size> f_bbox_ctrl_to_lp;
    sync_fifo<trv_ctrl_req_t, fifo_size> f_lp_to_trv_ctrl;
    sync_fifo<bbox_req_t, fifo_size> f_bbox_ctrl_to_hp;
    sync_fifo<trv_ctrl_req_t, fifo_size> f_hp_to_trv_ctrl;
    sync_fifo<result_t, fifo_size> f_trv_ctrl_to_shader;
    sync_fifo<ist_ctrl_req_t, fifo_size> f_trv_ctrl_to_ist_ctrl;
    sync_fifo<ist_req_t, fifo_size> f_ist_ctrl_to_ist;
    sync_fifo<ist_ctrl_req_t, fifo_size> f_ist_to_ist_ctrl;
